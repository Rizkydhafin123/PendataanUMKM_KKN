...
function EditUMKMContent() {
  ...
  const loadUMKMData = async () => {
    try {
      ...
      if (!data) {
        console.log("Data UMKM tidak ditemukan atau Anda tidak memiliki akses, mengarahkan ke /umkm.")
        router.push("/umkm")
        return
      }
      ...
      console.log("Gagal memuat data UMKM, mengarahkan ke /umkm.")
      router.push("/umkm")
    } finally {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.log("Data UMKM berhasil diperbarui! Mengarahkan ke /umkm.")
      router.push("/umkm")
    } catch (error) {
